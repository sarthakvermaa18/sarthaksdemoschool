...
const Join_us = () => {
  return (
    <div className='bg-white'>
      <div className='newsletter-section m-auto pt-5' style={{ background: " rgb(253,199,48)", background: "linear-gradient(90deg, rgba(253,199,48,1) 12%, rgba(249,167,50,1) 44%, rgba(243,118,52,1) 100%)" }}>
        <section >
